...
<main class="container py-4" style="max-width: 900px;">
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h1 class="mb-0">Creer une annonce</h1>
    </div>
...
<% if (success != null) { %>
    <div class="alert alert-success" role="alert">
        <div><%= success %></div>
        <div>Votre annonce a bien ete envoyee.</div>
    </div>
<% } %>
...
<form method="post" action="" class="card p-4 shadow-sm">
    <div class="mb-3">
        ...
        <input type="text" id="title" name="title" value="<%= formTitle == null ? "" : formTitle %>" class="form-control" required>
    ...
    <div class="mb-3">
        ...
        <textarea id="description" name="description" rows="5" class="form-control" required><%= formDescription == null ? "" : formDescription %></textarea>
    ...
    <div class="mb-3">
        ...
        <input type="text" id="adress" name="adress" value="<%= formAdress == null ? "" : formAdress %>" class="form-control" required>
    ...
    <div class="mb-3">
        ...
        <input type="email" id="mail" name="mail" value="<%= formMail == null ? "" : formMail %>" class="form-control" required>
        ...
        <select id="categoryId" name="categoryId" class="form-select" required>
            ...
            <% if (categories != null) { %>
                <% for (Category cat : categories) { %>
                    <option value="<%= cat.getId() %>" <%= formCategoryId != null && formCategoryId.equals(cat.getId()) ? "selected" : "" %>><%= cat.getLabel() %></option>
                <% } %>
            <% } %>
        </select>
...
<footer class="border-top bg-white">
    <div class="container py-3 text-muted small">Todo App - Creation d'annonce</div>
</footer>
</body>
</html>